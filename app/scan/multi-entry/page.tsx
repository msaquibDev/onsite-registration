...
import { ArrowLeft, Scan as ScanIcon, CheckCircle } from 'lucide-react';
...
export default function MultiEntryScanPage() {
  ...
  const handleScan = async () => {
    ...
    try {
      ...
      toast({
        title: "Success",
        description: `${attendee.name} scanned successfully`,
      });
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50">
      <header className="bg-blue-950 shadow-sm border-b">
        <div className="container mx-auto px-4 py-4 flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-primary text-white">Multi Entry Scan</h1>
            <p className="text-sm text-muted-foreground">Scan attendees for multiple entries</p>
          </div>
        </div>
      </header>
